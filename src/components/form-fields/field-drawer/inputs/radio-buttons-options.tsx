...
export const RadioButtonsOptions: React.FC<{ isList?: boolean }> = ({ isList }) => {
                  ...
                  <div key={option.id} className='option'>
                    <Field
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                        ...
                        setFieldValue(`${name}.${index}.text`, newValue);
                        setFieldValue(`${name}.${index}.optionProps.value`, newValue);
                      }}
                    />
